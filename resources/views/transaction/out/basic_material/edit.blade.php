...
<main id="main-container">
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <form action="{{ route('basic_material_out.update', $tbm->id) }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="category" class="form-control" id="category" disabled>
                                        ...
                                        <option value="4" {{ $tbm->category == '4' ? 'selected' : '' }}>Penjualan</option>
                                        <option value="5" {{ $tbm->category == '5' ? 'selected' : '' }}>Rusak</option>
                                    </select>
                                </div>
                            </div>
                        </div>
